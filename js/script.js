...
function preloadImages() {
	...
	const imageSources =
		imageSourceMap[nameParam] || imageSourceMap.default;
...
// Thay link này bằng link bài hát bạn muốn (hỗ trợ mp3, ogg)
// Ví dụ một số link miễn phí đẹp phù hợp pháo hoa năm mới:
backgroundMusic.src = "./audio/tam-biet-nam-cu-qua.mp3"; // thay bằng link thật

// Một số bài gợi ý đẹp cho pháo hoa năm mới (bạn có thể dùng):
// 1. Nhạc nền năm mới nhẹ nhàng:
// "https://audio-previews.elements.envatousercontent.com/files/468589843/preview.mp3"

// 2. Nhạc Tết Việt Nam vui tươi:
// Tìm file mp3 như "Happy New Year", "Chúc Mừng Năm Mới", "Xuân Hội"...

// 3. Hoặc upload file lên host rồi dùng link trực tiếp:
// backgroundMusic.src = "./music/happy-new-year.mp3";

backgroundMusic.loop = true;        // Lặp lại liên tục
backgroundMusic.volume = 0.4;      // Âm lượng vừa phải (0.0 đến 1.0)
backgroundMusic.preload = "auto";

// Hàm bật nhạc nền (chỉ phát khi người dùng đã tương tác)
...
// Tự động bật nhạc khi người dùng click/touch vào màn hình lần đầu
document.body.addEventListener("pointerdown", startBackgroundMusic, { once: true });
